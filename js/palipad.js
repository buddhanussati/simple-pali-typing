(function() {
    ...
    function Pad(elem) {
        ...
        this.paliMode = true;  
        this.maxCaretPosAge = 300; 
        this.caretPosUpdatedTime = -this.maxCaretPosAge; 
    ...
    Pad.prototype = {
        ...
        updatePaliMode: function() {
            ...
            if (this.keyDown) {
                ...
                if (this.shiftWait && this.keyCode == KC_SHIFT) {
                    this.shiftWait = false;
                    // this.paliMode = !this.paliMode; // TOGGLE DISABLED (Always On)
                    updated = true;
                }
            }
            if (updated) {
        ...
        convertTyping: function() {
            ...
            // We clear suggestions here, though Menu.prototype now ignores them anyway.
            menu.chars = [];

            // --- REPLACED LOGIC START ---
            // We removed the check for 'keyCode' and 'secondCharIndex'
            // because mobile phones return keyCode 229 for everything.
            if (paliChar) {
    ...
    Menu.prototype = {
        ...
        applyStyle: function() {
            ...
            // The content box (only visible when selecting text)
        ...
        setContentMode: function(contentMode) {
            ...
            if (contentMode === 'TYPING') {
                // --- CHANGE: Force hide content while typing ---
                // This disables the "A a I i..." suggestion popup entirely.
                this.display('.content', false);
            } else if (contentMode === 'CONVERT') {
                // Keep the menu visible ONLY if you select text to convert it manually
